...
app.post("/api/request", async (req, res) => {
  try {
    ...
    const approvalLink = `https://tnpetro.github.io/email-approval/#/approve/${request.id}/${token.token}`;
  ...
  try {
    ...
    if (approvalToken.role === "functional") {
      ...
      await sendMail(
        ...
        `<p><a href="https://tnpetro.github.io/email-approval/#/approve/${id}/${next.token}">HR Approval Link</a></p>`
      );
    }
    ...
    if (approvalToken.role === "hr") {
      ...
      await sendMail(
        ...
        `<p><a href="https://tnpetro.github.io/email-approval/#/approve/${id}/${next.token}">IT Approval Link</a></p>`
      );
    }
